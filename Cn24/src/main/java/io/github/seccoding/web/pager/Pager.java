...
public abstract class Pager {
	...
	private int totalArticleCount; // 전체 게시글 개수

	protected int printArticle; // 한 page 당 나오는 게시글의 개수
	public int printPage; // 보여지는 page의 개수

	protected int startArticleNumber; // 게시글의 시작 번호
	protected int endArticleNumber; // 게시글의 끝 번호

	public int totalPage;
	public int totalGroup;

	public int nowGroupNumber; // 현재 pagenation의 번호

	public int groupStartPage; 

	public int nextGroupPageNumber; // 다음 pagenation의 번호
	public int prevGroupPageNumber; // 이전 pagenation의 번호

	public int pageNo; // 내가 보고 싶은 page 번호
