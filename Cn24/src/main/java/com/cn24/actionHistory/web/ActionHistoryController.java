package com.cn24.actionHistory.web;
...
import com.cn24.actionHistory.service.ActionHistoryService;
import com.cn24.actionHistory.vo.ActionHistorySearchVO;
import com.cn24.util.DateUtil;
...
public class ActionHistoryController {
	...
	public ModelAndView viewActionHistoryPage(ActionHistorySearchVO actionHistorySearchVO,
		...
		if (actionHistorySearchVO.getPageNo() == -1) {
			...
			if (actionHistorySearchVO == null) {
				...
				// 검색날짜 초기화 함수 호출
				setInitiateSearchDate(view, actionHistorySearchVO);
			}
		}
		
		// year, month, date -> startDate
		actionHistorySearchVO.setStartDate(DateUtil.makeDate(actionHistorySearchVO.getStartDateYear(),
				actionHistorySearchVO.getStartDateMonth(), actionHistorySearchVO.getStartDateDate()) + " 00:00:00");
		// year, month, date -> endDate
		actionHistorySearchVO.setEndDate(DateUtil.makeDate(actionHistorySearchVO.getEndDateYear(),
				actionHistorySearchVO.getEndDateMonth(), actionHistorySearchVO.getEndDateDate()) + " 23:59:59");
		...
		int endDateMaximumDate = DateUtil.getActualMaximumDate(Integer.parseInt(actionHistorySearchVO.getEndDateYear()),
	...
	/*
	 *  year, month가 변경될 때마다 date 달라지게 하기 위해
	 */
	@RequestMapping("/api/data/max/{year}/{month}")
	...
	private void setInitiateSearchDate(ModelAndView view, ActionHistorySearchVO actionHistorySearchVO) {
